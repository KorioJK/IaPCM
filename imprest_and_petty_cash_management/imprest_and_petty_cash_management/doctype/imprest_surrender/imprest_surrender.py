...
# class ImprestRequisitionandPettyCash(Document):
# 	pass
# Copyright (c) 2023, MCB Technologies LTD and Contributors
# See license.txt
...
class ImprestSurrender(AccountsController):
	def __init__(self, *args, **kwargs):
		super(ImprestSurrender, self).__init__(*args, **kwargs)
	...
	def on_submit(self):
		...
		doc = frappe.get_doc('Surrendered', self.imprest_or_petty_cash_entry)
		doc.is_surrendered = True
		doc.save()	
	def on_cancel(self):
...
def make_reverse_journal_entry(source_name, target_doc=None):
	...
	doclist = get_mapped_doc(
		"Imprest Requisition and Petty Cash",
		source_name,
		{
			"Imprest Requisition and Petty Cash": {"doctype": "Imprest Requisition and Petty Cash", "validation": {"docstatus": ["=", 1]}},
